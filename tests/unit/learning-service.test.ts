...
function makeMockStorage(overrides: Partial<StorageAdapter> = {}): StorageAdapter {
  return {
    ...
    getOpenFindings: vi.fn().mockResolvedValue([]),
    updateFinding: vi.fn().mockResolvedValue(null),
    createGotcha: vi.fn().mockResolvedValue({}),
    getGotcha: vi.fn().mockResolvedValue(null),
    getGotchas: vi.fn().mockResolvedValue([]),
    updateGotcha: vi.fn().mockResolvedValue(null),
    findSimilarGotcha: vi.fn().mockResolvedValue(null),
    createRunSummary: vi.fn().mockResolvedValue({}),
    getRunHistory: vi.fn().mockResolvedValue([]),
    getRelevantDecisions: vi.fn().mockResolvedValue([]),
    getRelevantFindings: vi.fn().mockResolvedValue([]),
    ...overrides,
  };
}
